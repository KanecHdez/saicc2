...
describe('Puesto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'puesto', component: PuestoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.puestos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to puestoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPuestoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPuestoIdentifier).toHaveBeenCalledWith(entity);
