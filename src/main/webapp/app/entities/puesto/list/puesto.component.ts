...
import { EntityArrayResponseType, PuestoService } from '../service/puesto.service';
...
export class PuestoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPuesto): number => this.puestoService.getPuestoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.puestos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPuesto[] | null): IPuesto[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.puestoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
